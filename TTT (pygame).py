...
def draw_board():
    ...
    for x in range(1,3):
        pygame.draw.line(gameDisplay, GRID_COLOR, (0, 200 * x), (WIDTH,200 * x), LINE_WIDTH)
        pygame.draw.line(gameDisplay, GRID_COLOR, (200 * x, 0), (200 * x, HEIGHT), LINE_WIDTH)
